...
export default function Sidebar({ activeTab, activeSubTab, onChangeTab }) {
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: 28, height: 28 }}>
